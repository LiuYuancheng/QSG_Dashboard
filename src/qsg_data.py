#!/usr/bin/python
#-----------------------------------------------------------------------------
# Name:        qsg_v02.py [python3]
#
# Purpose:     This test module will create a dummy QSG manager to update/feedback 
#              the Gateway node's reported information to the google map which created
#              by <flaskMap_v02.py>, this module need to be executed before we run 
#              <flaskMap_v02.py>
#              
...
def updateNodeAct():
    ...
    for data in update_json_list:
        curr_data_info = {'no': ast.literal_eval(data[1]), 'updateInfo': json.loads(data[2])}
